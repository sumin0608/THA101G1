...
<%
    ...
    System.out.println("orderv5 + L" + L);
//以上是訂單用到
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 ">
                                            ...
                                            <button class="btn btn-primary" type="button"
                                                    id="btn-close-search">關閉
                                            </button>
                                            <button class="btn btn-primary" type="reset"
                                                    id="btn-reset-search">重置
                                            </button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th scope="row" style="background-color:#D9D9D9"><font size="2"
                                                                                   color="#404040">商品圖片</font></th>
                            <td><img class="card-img-top" src="lib/img/<%=p.getPicture() %>" alt="..."
                        ...
                        <tr>
                            <th scope="row" style="background-color:#D9D9D9"><font size="2"
                                                                                   color="#404040">住家地址</font></th>
                            <td><input name="address" class="form-control" type="search" placeholder="輸入住家地址..."
                                       aria-label="Search" maxlength="45"></td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th scope="row" style="background-color:#D9D9D9"><font size="2"
                                                                                   color="#404040">電子信箱</font></th>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="提交"
