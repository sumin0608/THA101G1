        ...
        <div class="row">
            <div class="col-12">
		         <div style="border-color:gray;border-width:1px;border-style:solid;padding:5px; margin-top:20px;">
		           <form action="TotalShopServlet" method="post">
				     <table class="table">
						  <thead>
						    <tr>
						  ...
						  <tbody>
						    ...
						    <tr>
						      <th scope="row" style="background-color:#D9D9D9"><font size="2" color="#404040">會員編號</font></th>
						      <td><%=m.getId() %></td>
						      <td></td>
						      <td></td>
						    </tr>
						    ...
						    <tr>
						      ...
						      <!--<td><input name="name" class="form-control" type="search" placeholder="輸入姓名..." aria-label="Search" maxlength="5" style="width:200px"><%=m.getName() %></td>-->
						      <td><%=m.getName() %></td>
						      <td></td>
						      <td></td>
						    </tr>
						    ...
						    <tr>
						      ...
						      <!--<td><input name="email" class="form-control" type="email" placeholder="輸入電子信箱..." aria-label="Search" maxlength="50"><%=m.getEmail() %></td>-->
						      <td><%=m.getEmail() %></td>
						      <td></td>
						      <td></td>
						    </tr>
