		                ...
		                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4">
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/basketball03.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">斯伯丁 2號籃球</h5>
		                                    <!-- Product reviews-->
			                            ...
			                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
			                                <div class="text-center">
			                                	<form action="BuyButtonServlet" method="post">
			                                		<input name="productName" type="hidden" value="斯伯丁 2號籃球">
		                     ...
		                     <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/basketball04.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">黑橘色 籃球</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="黑橘色 籃球">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
		                     ...
		                     <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/basketball05.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">斯伯丁白色花紋球</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="斯伯丁白色花紋球">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
		                     ...
		                     <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/basketball06.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">室外用籃球</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                                <div class="text-center">
		                                	<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="室外用籃球">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                </form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/basketball12.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">深藍色籃球</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="深藍色籃球">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/basketball13.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">漸層色籃球</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="漸層色籃球">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/basketball14.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">賽爾提克籃球</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="賽爾提克籃球">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
