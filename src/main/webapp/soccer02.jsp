		                ...
		                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4">
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/soccer09.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">銀色足球</h5>
		                                    <!-- Product reviews-->
			                            ...
			                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
			                                <div class="text-center">
			                                	<form action="BuyButtonServlet" method="post">
			                                		<input name="productName" type="hidden" value="銀色足球">
		                     ...
		                     <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/soccer10.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">足球員護膝</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="足球員護膝">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
		                     ...
		                     <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/soccer11.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">足球襪</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="足球襪">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
		                     ...
		                     <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/soccer12.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">練習用足球</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                                <div class="text-center">
		                                	<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="練習用足球">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                </form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/soccer13.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">黃色足球襪</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                                <div class="text-center">
		                                 	<form action="BuyButtonServlet" method="post">
		                                 			<input name="productName" type="hidden" value="黃色足球襪">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                </form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/soccer14.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">藍色足球襪</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                                <div class="text-center">
		                                	<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="藍色足球襪">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                </form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/soccer15.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">紅色足球襪</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                                <div class="text-center">
		                                	<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="紅色足球襪">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                </form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/soccer16.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">玩具足球</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                                <div class="text-center">
		                                	<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="玩具足球">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                </form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/soccer17.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">成功牌足球</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="成功牌足球">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/soccer18.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">小小兵樣式足球</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="小小兵樣式足球">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/soccer19.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">日式足球</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="日式足球">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/soccer20.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">護膝繃帶</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="護膝繃帶">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
