		                ...
		                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4">
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/base09.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">黑色鋁製球棒</h5>
		                                    <!-- Product reviews-->
			                            ...
			                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
			                                <div class="text-center">
			                                	<form action="BuyButtonServlet" method="post">
			                                		<input name="productName" type="hidden" value="黑色鋁製球棒">
		                     ...
		                     <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/base10.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">紅色木質球棒</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="紅色木質球棒">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
		                     ...
		                     <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/base11.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">多樣式球棒</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="多樣式球棒">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
		                     ...
		                     <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/base12.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">耐用手套</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                                <div class="text-center">
		                                	<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="耐用手套">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                </form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/base13.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">棒球護膝</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                                <div class="text-center">
		                                 	<form action="BuyButtonServlet" method="post">
		                                 			<input name="productName" type="hidden" value="棒球護膝">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                </form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/base14.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">大聯盟用球</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                                <div class="text-center">
		                                	<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="大聯盟用球">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                </form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/base15.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">棒球襪子</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                                <div class="text-center">
		                                	<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="棒球襪子">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                </form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/base16.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">中職用球</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                                <div class="text-center">
		                                	<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="中職用球">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                </form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/basketball17.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">棒球皮帶</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="棒球皮帶">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/base18.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">棒球旅行袋</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="棒球旅行袋">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/base19.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">打擊練習網</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="打擊練習網">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
		                    ...
		                    <div class="col mb-5">
		                        <div class="card h-100">
		                            ...
		                            <!-- Product image-->
		                            <img class="card-img-top" src="lib/img/base20.jpg"
		                                alt="..." />
		                            <!-- Product details-->
		                            <div class="card-body p-4" style="color: red;">
		                                <div class="text-center">
		                                    <!-- Product name-->
		                                    <h5 class="fw-bolder">捕手面具</h5>
		                                    <!-- Product reviews-->
		                                    <div class="d-flex justify-content-center small text-warning mb-2">
		                                        <div class="bi-star-fill"></div>
		                                        <div class="bi-star-fill"></div>
		                            ...
		                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
		                                <div class="text-center">
		                                		<form action="BuyButtonServlet" method="post">
		                                			<input name="productName" type="hidden" value="捕手面具">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="購買" style="margin-bottom:20px">
			                                		<input name="input" class="btn btn-outline-dark mt-auto" type="submit" value="加入購物車" style="margin-bottom:20px">
			                                	</form>
		                                </div>
