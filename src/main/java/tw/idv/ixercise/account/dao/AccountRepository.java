...
//    ===========================================================================
    ...
    @Query(
            value = "select * from ACCOUNT where accountEmail = :accountEmail AND accountPassword = :accountPassword",
            nativeQuery = true
    )
    Account findForAdLogin(String accountEmail, String accountPassword);
