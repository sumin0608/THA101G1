package tw.idv.ixercise.ecpay.payment.integration;
...
import tw.idv.ixercise.ecpay.payment.integration.domain.ATMRequestObj;
import tw.idv.ixercise.ecpay.payment.integration.domain.AioCheckOutALL;
import tw.idv.ixercise.ecpay.payment.integration.domain.AioCheckOutApplePay;
import tw.idv.ixercise.ecpay.payment.integration.domain.AioCheckOutATM;
import tw.idv.ixercise.ecpay.payment.integration.domain.AioCheckOutBARCODE;
import tw.idv.ixercise.ecpay.payment.integration.domain.AioCheckOutCVS;
import tw.idv.ixercise.ecpay.payment.integration.domain.AioCheckOutDevide;
import tw.idv.ixercise.ecpay.payment.integration.domain.AioCheckOutOneTime;
import tw.idv.ixercise.ecpay.payment.integration.domain.AioCheckOutPeriod;
import tw.idv.ixercise.ecpay.payment.integration.domain.AioCheckOutWebATM;
import tw.idv.ixercise.ecpay.payment.integration.domain.CVSOrBARCODERequestObj;
import tw.idv.ixercise.ecpay.payment.integration.domain.CreateServerOrderObj;
import tw.idv.ixercise.ecpay.payment.integration.domain.DoActionObj;
import tw.idv.ixercise.ecpay.payment.integration.domain.FundingReconDetailObj;
import tw.idv.ixercise.ecpay.payment.integration.domain.InvoiceObj;
import tw.idv.ixercise.ecpay.payment.integration.domain.QueryCreditCardPeriodInfoObj;
import tw.idv.ixercise.ecpay.payment.integration.domain.QueryTradeInfoObj;
import tw.idv.ixercise.ecpay.payment.integration.domain.QueryTradeObj;
import tw.idv.ixercise.ecpay.payment.integration.domain.TradeNoAioObj;
import tw.idv.ixercise.ecpay.payment.integration.ecpayOperator.EcpayFunction;
import tw.idv.ixercise.ecpay.payment.integration.errorMsg.ErrorMessage;
import tw.idv.ixercise.ecpay.payment.integration.exception.EcpayException;
import tw.idv.ixercise.ecpay.payment.integration.verification.VerifyAioCheckOut;
import tw.idv.ixercise.ecpay.payment.integration.verification.VerifyCreateServerOrder;
import tw.idv.ixercise.ecpay.payment.integration.verification.VerifyDoAction;
import tw.idv.ixercise.ecpay.payment.integration.verification.VerifyFundingReconDetail;
import tw.idv.ixercise.ecpay.payment.integration.verification.VerifyQueryCreditTrade;
import tw.idv.ixercise.ecpay.payment.integration.verification.VerifyQueryTrade;
import tw.idv.ixercise.ecpay.payment.integration.verification.VerifyQueryTradeInfo;
import tw.idv.ixercise.ecpay.payment.integration.verification.VerifyTradeNoAio;
